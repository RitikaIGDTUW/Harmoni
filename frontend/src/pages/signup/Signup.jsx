        ...
        <div className="flex flex-col items-center justify-center min-w-96 mx-auto">
            <div className="w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-10">
                <h1 className="text-3xl font-semibold text-center text-gray-400">
                    Signup<span className="text-blue-900"> Chat App</span>
                </h1>
                ...
                <form onSubmit={handleSubmit}>
                    <div>
                        ...
                        <input
                            ...
                            value={inputs.fullname} // Updated from inputs.fullName
                            onChange={(e) => setInputs({ ...inputs, fullname: e.target.value })} // Updated from fullName
                        />
                    </div>
                    <div>
                        <label className="label p-2">
