    ...
    <div className='flex flex-col items-center justify-center min-w-96 mx-auto'>
        <div className='w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-10'>
            <h1 className='text-3xl font-semibold text-center text-gray-100 '>Login
                <span className='text-blue-900'> Harmoni</span>
            </h1>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div>
                    <button className='btn btn-block btn-sm mt-2  border-slate-600' disabled={loading}>
...
//                   </div>
//                   <a href="#" className='text-sm hover:underline hover:text-blue-900 mt-2 font-semibold inline-block'>{"Don't"} have an account?</a>
//                   <div>
